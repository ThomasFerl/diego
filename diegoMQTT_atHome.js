...
{
   console.log('try to publish : "'+JSON.stringify(message)+'"');
...
function publishPromise( topic, message ) 
{
...
async function syncPublish(topic, message) 
{
    try {
 ...
 module.exports.syncPublish = syncPublish;
